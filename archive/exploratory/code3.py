...
print("Starting 5-Fold Validation with Adaptive Dynamic Loss Scaling...")
...
for fold, (train_idx, test_idx) in enumerate(kf.split(X)):
    ...
    # Cross-over non-linear empirical features
    ...
    for epoch in range(1500):
        ...
        # UPGRADE: Adaptive Multi-Objective Loss Scaling
        # Dynamically alters physics weight based on data loss convergence progress
        with torch.no_grad():
            adaptive_weight = 0.001 * (loss_data.item() + 1e-5)
            
        total_hybrid_loss = loss_data + adaptive_weight * loss_physics
...
# Unified paired t-test over complete distribution profiles
...
if p_value < 0.05:
    ...
    print("The performance gap is mathematically isolated from margins of error.")
else:
